...
// JavaScript to open and close the pop-up for each link
...
closeButtons.forEach(button => {
  button.addEventListener('click', function() {
    const popupToClose = this.getAttribute('data-close');
    document.getElementById(popupToClose).style.display = 'none'; // Close the corresponding pop-up
  });
});
